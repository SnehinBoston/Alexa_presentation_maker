...
from mekko_chart import create_mekko_chart
from Bar_stacked import create_stacked_bar_chart
from Scatter_bubble import create_scatter_bubble_chart
...
# TEMPLATE_PRESENTATION = "./auxi_Template.pptx"

app = Flask(__name__)

# Stacked bar chart, scatter bubble chart, butterfly chart, clustered column chart, area chart, better visualization library for Processflow
def get_summarized_sections(ppt_subject):
    ...
    if not pages_search and not page_suggest:
        print("Not page search and page suggest.")
        return False
