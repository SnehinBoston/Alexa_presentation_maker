...
stmt = "Build a slide deck of 10 slides on the topic India from wikipedia. How has been your day? Please turn on the lights. Build a slide deck. This is great. Please show me a list of restaurants near me."
print(summarize_lsa(stmt))